use iced_runtime::core::{
    ...
    widget::{self, Tree},
    Alignment, BorderRadius, Clipboard, Color, Element, Event, Layout, Length, Point, Rectangle,
    Shell, Size, Widget,
};
...
where
    Renderer: iced_runtime::core::Renderer,
    Message: Clone,
{
    ...
    fn draw(
        ...
        theme: &<Renderer as iced_runtime::core::Renderer>::Theme,
...
where
    Renderer: 'a + iced_runtime::core::Renderer,
    Message: 'a + Clone,
{
    fn from(modal: Dialog<'a, Message, Renderer>) -> Self {
        Element::new(modal)
    }
}
